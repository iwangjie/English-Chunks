...
export const scenes: Scene[] = [
  {
    id: 'daily-greetings',
    title: '日常问候',
    description: '学习日常生活中的问候语和寒暄',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>`
  },
  {
    id: 'restaurant',
    title: '餐厅用餐',
    description: '掌握在餐厅点餐和用餐的对话',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3h18v18H3z"></path><path d="M12 12h.01"></path><path d="M16 12h.01"></path><path d="M8 12h.01"></path><path d="M3 9h18"></path><path d="M3 15h18"></path></svg>`
  },
  {
    id: 'asking-directions',
    title: '问路指路',
    description: '学习如何询问和指引方向',
