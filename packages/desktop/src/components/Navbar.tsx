    ...
    <nav className={styles.navbar}>
      <div className={styles.container}>
        <Link to="/" className={styles.logoLink}>
          <span className={styles.logo}>English Chunks</span>
        </Link>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <div className={`${styles.menu} ${isMenuOpen ? styles.menuOpen : ''}`}>
            ...
            <Link to="/scenes" className={`${styles.menuItem} ${pathname === '/scenes' ? styles.active : ''}`}>
              场景练习
            </Link>
            ...
            <Link to="/settings" className={`${styles.menuItem} ${pathname === '/settings' ? styles.active : ''}`}>
              设置
            </Link>
          </div>
