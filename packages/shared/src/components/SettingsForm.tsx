...
import { useStorage } from '../contexts/PlatformContext';
...
const SettingsForm = () => {
    ...
    useEffect(() => {
        const loadSettings = async () => {
            ...
            const savedOpenAISpeechSettings = await storage.getItem('openAISpeechSettings');
    ...
    const handleOpenAISpeechSettingsChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        const { name, value } = e.target;
        const newSettings = {
            ...openAISpeechSettings,
            [name]: value
        };
        setOpenAISpeechSettings(newSettings);
        await storage.setItem('openAISpeechSettings', JSON.stringify(newSettings));
    };
